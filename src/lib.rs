...
mod tests {
    ...
    fn uwu_zero_and_one() {
        ...
        assert_eq!(UwU::<f32>::zero(), UwU { x: 0.0f32, y: 0.0f32, z: 0.0f32 });
        assert!(UwU::<f32>::zero().is_zero());
        assert_eq!(UwU::<f32>::one(), UwU { x: 1.0f32, y: 1.0f32, z: 1.0f32 });
    }
    ...
    #[test]
    fn uwu_arithmetic() {
        let a = UwU::<f32> { x: 1.0f32, y: 2.0f32, z: 3.0f32 };
        let b = UwU::<f32> { x: 4.0f32, y: 5.0f32, z: 6.0f32 };
        assert_eq!(a + b, UwU::<f32> { x: 5.0f32, y: 7.0f32, z: 9.0f32 });
        assert_eq!(b - a, UwU::<f32> { x: 3.0f32, y: 3.0f32, z: 3.0f32 });
        assert_eq!(a * UwU::<f32> { x: 2.0f32, y: 2.0f32, z: 2.0f32 }, UwU::<f32> { x: 2.0f32, y: 4.0f32, z: 6.0f32 });
        assert_eq!(-a, UwU::<f32> { x: -1.0f32, y: -2.0f32, z: -3.0f32 });
    }
}
